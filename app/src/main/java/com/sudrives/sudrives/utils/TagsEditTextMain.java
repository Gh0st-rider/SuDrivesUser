 ...
 * BETA
 */
public class TagsEditTextMain extends AutoCompleteTextView {
    ...
    public TagsEditTextMain(Context context) {
        super(context);
        init(null, 0, 0);
    }

    public TagsEditTextMain(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0, 0);
    }

    public TagsEditTextMain(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TagsEditTextMain(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
